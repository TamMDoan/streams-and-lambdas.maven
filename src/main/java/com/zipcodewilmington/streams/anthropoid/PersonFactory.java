...
public final class PersonFactory {
    ...
    public Person[] createPersonArray(int arrayLength) {
        List<Person> persons = createPersonList(arrayLength);
        Class<Person> clazz = (Class<Person>) persons.get(0).getClass();
        Person[] personArr = (Person[]) Array.newInstance(clazz, persons.size());
